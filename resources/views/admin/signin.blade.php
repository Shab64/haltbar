        ...
        <div class="card">
            <div class="row align-items-stretch text-center">
                <div class="col-md-6 img-card-side">
                    <img src="{{ asset('public/assets/images/auth/auth-side1.jpg') }}" alt="" class="img-fluid">
                ...
                <div class="col-md-6">
                    <div class="card-body">
                        <form method="POST" action="{{ Route('admin.check') }}">
                            <div class="text-left">
                                <h4 class="mb-3 f-w-600">Welcome to <span class="text-primary">Admin Panel</span></h4>
