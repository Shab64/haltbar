                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $single_product['ProductName'] }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Product Price</label>
                                    <input type="text" value="{{ $single_product['SinglePrice'] }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Quantity</label>
                                    <input type="number" value="{{ $single_product['SingleQuantity'] }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class='form-control' id="classic-editor">{{ $single_product['RetailDescription'] }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ Route('admin.updateChanges') }}">
                            @csrf
                            <input type="text" value="ralawise" name="supplier" hidden/>
                            <input type="text" value="{{ $single_product['id'] }}" name="single_pro_id" hidden />
                            <div class="appendRanges">
                                @if(!empty($ralawise_pricings))
                                @foreach($ralawise_pricings as $k=>$pricing)
                                ...
                                <div class="d-flex justify-content-between {{ $k == 0 ? '' : 'mt-3' }}">
                                    ...
                                    <div>
                                        <?php $totalPrice =  ($single_product['SinglePrice'] * $pricing['service_charges_pp']);
...
<script>
    ...
    function changePrice(no) {
        ...
        let singlePrice = '<?= $single_product['SinglePrice'] ?>';
