    ...
    <div class="pcoded-content">
        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 text-right mb-4">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addDelivery"><i class="fas fa-plus"></i>
                    Add Delivery
                </button>
            </div>
        </div>
                                            ...
                                            <table id="report-table" class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            {{ strip_tags($delivery['description']) }}
                                                        </td>
                                                        <td class="align-middle"><span class="badge badge-success">Published</span></td>

                                                        <td class="align-middle table-action"><a href="javascript:void(0);" data-toggle="modal" data-target="#editDelivery" class="btn btn-icon btn-outline-success"><i class="fas fa-edit"></i></a></td>
                                                    </tr>
                                                    @endif
...
<!-- Add Delivery Modal -->
<div id="addDelivery" class="modal fade bd-example-modal-md" tabindex="-1" role="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form id="cmsDelivery" action="#" class="row">
...
<!-- Edit Delivery Modal -->
<div id="editDelivery" class="modal fade bd-example-modal-md" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="h6">Edit Delivery</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form id="editDeliveryForm" action="#" class="row">
                            <input type="hidden" id="deliveryID" name="id" value="{{ !empty($delivery) ? $delivery['id'] : '' }}">
                            <div class="col-12 form-field">
                                <label for="Leads" class="title-small c-blue">Title</label>
                                <input type="text" name="title" id="edit_title" class="form-control" value="{{ !empty($delivery) ? $delivery['title'] : '' }}">
                                <small id="edit_error_title" class="form-text text-danger"></small>
                            </div>

                            <div class="col-12 form-field" style="margin-top: 10px;">
                                <label for="desc" class="form-label">Description</label>
                                <textarea name="description" id="summernoteUpdate" class="form-control edit_description">{{ !empty($delivery) ? $delivery['description'] : '' }}</textarea>
...
<!-- Add Delivery -->
<script>
    $('#cmsDelivery').on('submit', function(e) {
        e.preventDefault();
