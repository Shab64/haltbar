    ...
    <div class="pcoded-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Cookies Policy</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-12 text-right mb-4">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addCookies"><i class="fas fa-plus"></i>
                    Add Cookies
                </button>
            </div>
        </div>
                                            ...
                                            <table id="report-table" class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="align-middle">
                                                            {{ strip_tags($cookies['description']) }}
                                                        </td>
                                                        <td class="align-middle"><span class="badge badge-success">Published</span></td>

                                                        <td class="align-middle table-action"><a href="javascript:void(0);" data-toggle="modal" data-target="#editCookies" class="btn btn-icon btn-outline-success"><i class="fas fa-edit"></i></a></td>
                                                    </tr>
                                                    @endif
...
<!-- [ Main Content ] end -->
<!-- Add Cookies Modal -->
<div id="addCookies" class="modal fade bd-example-modal-md" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="h6">Add Cookies</h6>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form id="cmsCookies" action="#" class="row">
...
<!-- Edit Cookies Modal -->
<div id="editCookies" class="modal fade bd-example-modal-md" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form id="editCookiesForm" action="#" class="row">
                            <input type="hidden" id="cookiesID" name="id" value="{{ !empty($cookies) ? $cookies['id'] : '' }}">
                            <div class="col-12 form-field">
                                <label for="Leads" class="title-small c-blue">Title</label>
                                <input type="text" name="title" id="edit_title" class="form-control" value="{{ !empty($cookies) ? $cookies['title'] : '' }}">
                                <small id="edit_error_title" class="form-text text-danger"></small>
                            </div>

                            <div class="col-12 form-field" style="margin-top: 10px;">
                                <label for="desc" class="form-label">Description</label>
                                <textarea name="description" id="summernoteUpdate" class="form-control edit_description">{{ !empty($cookies) ? $cookies['description'] : '' }}</textarea>
...
<!-- Add Privacy -->
<script>
    $('#cmsCookies').on('submit', function(e) {
        e.preventDefault();
    ...
    $('#editCookiesForm').on('submit', function(e) {
        e.preventDefault();

        let _token = "{{csrf_token()}}";
        let id = $('#cookiesID').val();
