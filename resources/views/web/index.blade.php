...
<div class="sticky-header-next-sec ec-main-slider section section-space-pb">
    <div class="ec-slider swiper-container main-slider-nav main-slider-dot">
        <!-- Main slider -->
        <?php $slider = [
            'twenty X Aprons Offer.jpeg',
            '25 X Polos Offer.jpg',
            '50 x Hivi Offer.jpg',
            '50 X Masks Offer.jpg',
            'Clothing Banner.jpg',
            'Hospitality Banner.jpg',
            'Polo_ Hoodie_ sweats Super Deal Offer.jpg',
            'PPE Banner.jpg',
            'Printing Banner2.jpg'
        ]; ?>
        <div class="swiper-wrapper">
            @foreach($slider as $s)
            <div class="ec-slide-item swiper-slide d-flex" style='background-image: url("{{url('public/assets/images/slider/'.$s)}}");background-repeat: no-repeat;background-position: center center;background-size: 100%'>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="section-title">
                    <h2 class="ec-bg-title">Top Categories</h2>
            ...
            <div class="row">
                <!-- Product Content -->
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="fadeIn">
                    <div class="ec-product-inner">
                        <a href="{{route('products_by_type', 'T-Shirt')}}">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <div class="image">
                                        <img class="main-image" src="{{ asset('public/assets/web/images/categories/T Shirts.jpg') }}" alt="Product" />
                                        <img class="hover-image" src="{{ asset('public/assets/web/images/categories/T Shirts.jpg') }}" alt="Product" />
                                    </div>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title">
                                <a href="{{route('products_by_type', 'T-Shirt')}}">T-SHIRTS</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="fadeIn">
                    <div class="ec-product-inner">
                        <a href="{{route('products_by_type', 'Polo')}}">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <div class="image">
                                        <img class="main-image" src="{{ asset('public/assets/web/images/categories/Polos.jpg') }}" alt="Product" />
                                        <img class="hover-image" src="{{ asset('public/assets/web/images/categories/Polos.jpg') }}" alt="Product" />
                                    </div>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title">
                                <a href="{{route('products_by_type', 'Polo')}}">POLOS</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="fadeIn">
                    <div class="ec-product-inner">
                        <a href="{{route('products_by_type', 'Jacket')}}">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <div class="image">
                                        <img class="main-image" src="{{ asset('public/assets/web/images/categories/Jackets.jpg') }}" alt="Product" />
                                        <img class="hover-image" src="{{ asset('public/assets/web/images/categories/Jackets.jpg') }}" alt="Product" />
                                    </div>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title">
                                <a href="{{route('products_by_type', 'Jacket')}}">JACKETS</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="fadeIn">
                    <div class="ec-product-inner">
                        <a href="{{route('products_by_type', 'Coverall')}}">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <div class="image">
                                        <img class="main-image" src="{{ asset('public/assets/web/images/categories/PPE.jpg') }}" alt="Product" />
                                        <img class="hover-image" src="{{ asset('public/assets/web/images/categories/PPE.jpg') }}" alt="Product" />
                                    </div>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title">
                                <a href="{{route('products_by_type', 'Coverall')}}">RAIN SUITS</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="fadeIn">
                    <div class="ec-product-inner">
                        <a href="{{route('products_by_type', 'Hood')}}">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <div class="image">
                                        <img class="main-image" src="{{ asset('public/assets/web/images/categories/Hoodies.jpg') }}" alt="Product" />
                                        <img class="hover-image" src="{{ asset('public/assets/web/images/categories/Hoodies.jpg') }}" alt="Product" />
                                    </div>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title">
                                <a href="{{route('products_by_type', 'Hood')}}">HOODIES</a>
                            </h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6  ec-product-content" data-animation="fadeIn">
                    <div class="ec-product-inner">
                        <a href="{{route('products_by_type', 'Headwear')}}">
                            <div class="ec-pro-image-outer">
                                <div class="ec-pro-image">
                                    <div class="image">
                                        <img class="main-image" src="{{ asset('public/assets/web/images/categories/Caps.jpg') }}" alt="Product" />
                                        <img class="hover-image" src="{{ asset('public/assets/web/images/categories/Caps.jpg') }}" alt="Product" />
                                    </div>
                        ...
                        <div class="ec-pro-content">
                            <h5 class="ec-pro-title">
                                <a href="{{route('products_by_type', 'Headwear')}}">CAPS</a>
                            </h5>
                        </div>
                    </div>
                </div>
...
{{-- <div class="cat-desc"><span>Paper and Card Printing</span><span>510 Products</span></div>--}}
{{-- </a></li>--}}
...
{{-- <div class="cat-desc"><span>Pens</span><span>620 Products</span></div>--}}
{{-- </a></li>--}}
...
{{-- <div class="cat-desc"><span>Other Products</span><span>320 Products</span></div>--}}
{{-- </a></li>--}}
{{-- </ul>--}}
...
{{-- <a href="compare.html" class="ec-btn-group compare" title="Compare"><img src="{{ asset('public/assets/web/images/icons/compare.svg') }}" class="svg_img pro_svg" alt="" /></a>--}}
{{-- <button title="Add To Cart" class=" add-to-cart"><img src="{{ asset('public/assets/web/images/icons/cart.svg') }}" class="svg_img pro_svg" alt="" /> Add To--}}
{{-- Cart</button>--}}
{{-- <a class="ec-btn-group wishlist" title="Wishlist"><img src="{{ asset('public/assets/web/images/icons/wishlist.svg') }}" class="svg_img pro_svg" alt="" /></a>--}}
{{-- </div>--}}
{{-- </div>--}}
{{-- </div>--}}
{{-- <div class="ec-pro-content">--}}
...
{{-- <a href="#" class="quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img src="assets/images/icons/quickview.svg" class="svg_img pro_svg" alt="" /></a>--}}
{{-- <div class="ec-pro-actions">--}}
{{-- <a href="compare.html" class="ec-btn-group compare" title="Compare"><img src="{{ asset('public/assets/web/assets/images/icons/compare.svg') }}" class="svg_img pro_svg" alt="" /></a>--}}
{{-- <button title="Add To Cart" class=" add-to-cart"><img src="{{ asset('public/assets/web/assets/images/icons/cart.svg') }}" class="svg_img pro_svg" alt="" /> Add To--}}
{{-- Cart</button>--}}
{{-- <a class="ec-btn-group wishlist" title="Wishlist"><img src="{{ asset('public/assets/web/assets/images/icons/wishlist.svg') }}" class="svg_img pro_svg" alt="" /></a>--}}
{{-- </div>--}}
{{-- </div>--}}
{{-- </div>--}}
{{-- <div class="ec-pro-content">--}}
...
{{-- <div class="ec-pro-image">--}}
{{-- <a href="product-left-sidebar.html" class="image">--}}
{{-- <img class="main-image" src="{{ asset('public/assets/web/images/product-image/12_1.jpg')}}" alt="Product" />--}}
{{-- <img class="hover-image" src="{{ asset('public/assets/web/images/product-image/12_2.jpg')}}" alt="Product" />--}}
{{-- </a>--}}
...
{{-- <span class="ec-pro-opt-label">Color</span>--}}
{{-- <ul class="ec-opt-swatch ec-change-img">--}}
{{-- <li class="active"><a href="#" class="ec-opt-clr-img" data-src="{{ asset('public/assets/web/images/product-image/12_1.jpg')}}" data-src-hover="{{ asset('public/assets/web/images/product-image/12_1.jpg') }}" data-tooltip="Gray"><span style="background-color:#db9dff;"></span></a>--}}
{{-- </li>--}}
{{-- <li><a href="#" class="ec-opt-clr-img" data-src="{{ asset('public/assets/web/images/product-image/12_2.jpg')}}" data-src-hover="{{ asset('public/assets/web/images/product-image/12_2.jpg') }}" data-tooltip="Orange"><span style="background-color:#00ffff;"></span></a></li>--}}
{{-- <li><a href="#" class="ec-opt-clr-img" data-src="{{ asset('public/assets/web/images/product-image/12_3.jpg')}}" data-src-hover="{{ asset('public/assets/web/images/product-image/12_3.jpg') }}" data-tooltip="Green"><span style="background-color:#ffa7f3;"></span></a>--}}
{{-- </li>--}}
{{-- <li><a href="#" class="ec-opt-clr-img" data-src="{{ asset('public/assets/web/images/product-image/12_4.jpg')}}" data-src-hover="{{ asset('public/assets/web/images/product-image/12_4.jpg') }}" data-tooltip="Sky Blue"><span style="background-color:#89ff7e;"></span></a></li>--}}
{{-- </ul>--}}
{{-- </div>--}}
{{-- <div class="ec-pro-size">--}}
{{-- <span class="ec-pro-opt-label">Size</span>--}}
...
{{-- <div class="ec-pro-image">--}}
{{-- <a href="product-left-sidebar.html" class="image">--}}
{{-- <img class="main-image" src="{{ asset('public/assets/web/images/product-image/13_1.jpg') }}" alt="Product" />--}}
{{-- <img class="hover-image" src="{{ asset('public/assets/web/images/product-image/13_2.jpg') }}" alt="Product" />--}}
{{-- </a>--}}
{{-- <a href="#" class="quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ec_quickview_modal"><img src="{{ asset('public/assets/web/images/icons/quickview.svg') }}" class="svg_img pro_svg" alt="" /></a>--}}
{{-- <div class="ec-pro-actions">--}}
{{-- <a href="compare.html" class="ec-btn-group compare" title="Compare"><img src="{{ asset('public/assets/web/images/icons/compare.svg') }}" class="svg_img pro_svg" alt="" /></a>--}}
{{-- <button title="Add To Cart" class=" add-to-cart"><img src="{{ asset('public/assets/web/images/icons/cart.svg" class="svg_img pro_svg') }}" alt="" /> Add To--}}
{{-- Cart</button>--}}
