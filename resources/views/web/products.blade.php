                                ...
                                <ul style="height: 400px;overflow: hidden;overflow-y: scroll">
                                    ...
                                    <li>
                                        <div class="ec-sidebar-block-item">
                                            <input type="checkbox" class="my-category" name="cat[]" value="{{$cat}}" /> <a href="#">{{$cat}}</a><span class="checked"></span>
                                        </div>
                                    </li>
                                    @endforeach
                                </ul>
...
<script>
    ...
    $(".my-category").on('click',function(e){
        if ($(this).is(':checked') === true){
            ...
            let checkCategory = category.indexOf(this.value);
            if (checkCategory !== -1) {
                category.splice(checkCategory, 1);
            }
        }
        filter()
    })
    ...
    function filter(){
        ...
        $.post("{{route('filterBy')}}",{_token,size,category,price,supplier},function (resp){
            ...
            <div class="ec-pro-content">
            <h5 class="ec-pro-title"><a href="javascript:void(0)" onclick="singleProduct('${val1.id}','ralawise')">${val1.ProductName != "undefined" ? val1.Brand + ' ' + val1.ProductName : '-'}</a></h5>
            <!-- <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
            ...
            <div class="ec-pro-content">
            <h5 class="ec-pro-title"><a href="javascript:void(0)" onclick="singleProduct('${val1.id}','ralawise')">${val1.Product_Name != "undefined" ? 'Uneek ' + val1.Product_Name : '-'}</a></h5>
            <!-- <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
