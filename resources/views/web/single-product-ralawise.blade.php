                        ...
                        <div class="row">
                                    ...
                                    <div class="single-product-cover preview_active_color_code">
                                        ...
                                        <div class="single-slide">
                                            <div class="single-slide zoom-image-hover">
                                                <img id="changeImage" src="{{$image->image_url}}" class="img-responsive" />
                                            </div>
                                        </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="single-pro-desc single-pro-desc-no-sidebar">
                                <div class="single-pro-content">
                                    <h5 class="ec-single-title">{{ isset($singleProduct->title) ? $singleProduct->title : "-" }}</h5>
                                    <div class="ec-single-rating-wrap">

                                    </div>
                                    <div class="ec-single-desc">{!! isset($singleProduct->body) ? $singleProduct->body : '-' !!}</div>
                                    ...
                                    <div class="ec-single-price-stoke">
                                        ...
                                        <div class="ec-single-stoke">
                                            ...
                                            <span class="ec-single-sku">SKU#: {{ isset($singleProduct->code) ? $singleProduct->code : "-" }}</span>
                                        </div>
                                    </div>
                                    <div class="ec-pro-variation">
                                        ...
                                        <div class="ec-pro-variation-inner ec-pro-variation-color">
                                            ...
                                            <div class="ec-pro-variation-content">
                                                <ul>
                                                    ...
                                                    <li onclick="changeColor('{{ $color->rgb }}', '{{ $color->product_colourway_code }}', '{{ $color->product_style_code }}')"><span style="background-color:{{ $color->rgb }};"></span></li>
                                                    @endforeach
                                                    @endif
                                                </ul>
                                            </div>
                                        ...
                                        <div class="slider4 mt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <label id="inputSizes" style="font-size:20px; text-align:right; color:black; font-weight:600;" class="col-sm-2 col-form-label">{{ $size->code }} = </label>
                                                <div class="col-sm-10">
