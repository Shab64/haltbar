        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="section-title">
                    ...
                    <h2 class="ec-title" style="color: #EE8013 !important;">{{ !empty($getReturn) ? $getReturn['title'] : 'Return Policy' }}</h2>
                </div>
            </div>
            <div class="col-md-12">
                <div class="ec-common-wrapper">
                    <div class="col-sm-12 ec-cms-block">
                        <div class="ec-cms-block-inner">
                            ...
                            <p>{!! !empty($getReturn) ? $getReturn['description'] : 'No Description Found' !!}</p>
                        </div>
                    </div>
                </div>
            </div>
