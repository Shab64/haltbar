        ...
        <div class="ec-cart-inner">
            <div class="ec-cart-top">
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src="{{ asset('public/assets/web/images/product-image/6_1.jpg')}}" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src="{{ asset('public/assets/web/images/product-image/12_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src="{{ asset('public/assets/web/images/product-image/3_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
